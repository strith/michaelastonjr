...
export const skills: Skill[] = [
  ...
  { category: 'Database', name: 'Amazon RDS', isCore: true },
  ...
  { category: 'Database', name: 'MS SQL Server', isCore: true },
  { category: 'Database', name: 'MySQL', isCore: true },
  { category: 'Database', name: 'NoSQL', isCore: true },
  ...
  { category: 'Server', name: 'Amazon API Gateway' },
  ...
  { category: 'Server', name: 'Express', isCore: true },
  { category: 'Server', name: 'Flask' },
  { category: 'Server', name: 'GraphQL', isCore: true },
  { category: 'Server', name: 'hapi', isCore: true },
  ...
  { category: 'Client', name: 'Single Page Applications (SPAs)' },
  ...
  { category: 'Cloud & Infrastructure', name: 'GitHub Actions' },
  ...
  { category: 'Security & Compliance', name: 'Amazon IAM' },
  { category: 'Security & Compliance', name: 'CORS' },
  { category: 'Security & Compliance', name: 'JWT', isCore: true },
  { category: 'Security & Compliance', name: 'OAuth2' },
  { category: 'Security & Compliance', name: 'SAML' },
  { category: 'Security & Compliance', name: 'Vault' },

  // Testing & Automation
  { category: 'Testing & Automation', name: 'Amazon CloudWatch' },
  { category: 'Testing & Automation', name: 'Fabric', isCore: true },
  ...
  { category: 'Testing & Automation', name: 'Test-Driven Development (TDD)', isCore: true },
  { category: 'Testing & Automation', name: 'Unit Testing', isCore: true },

  // Data & AI/ML
  { category: 'AI/ML & Data', name: 'Generative AI Models (GPT-4, Amazon Titan, Anthropic Claude, Mistral AI)' },
  { category: 'AI/ML & Data', name: 'Amazon SageMaker' },
  { category: 'AI/ML & Data', name: 'Amazon Bedrock' },
  { category: 'AI/ML & Data', name: 'Amazon Lex' },
  { category: 'AI/ML & Data', name: 'Amazon Kendra' },
  { category: 'AI/ML & Data', name: 'Anaconda' },
  { category: 'AI/ML & Data', name: 'ArcGIS' },
  { category: 'AI/ML & Data', name: 'Consolidated Clinical Document Architecture (CCDA)', isCore: true },
  { category: 'AI/ML & Data', name: 'Continuity of Care Documents (CCD)' },
  { category: 'AI/ML & Data', name: 'HIPAA', isCore: true },
  { category: 'AI/ML & Data', name: 'HL7 FHIR', isCore: true },
  { category: 'AI/ML & Data', name: 'Jupyter Notebooks', isCore: true },
  { category: 'AI/ML & Data', name: 'Swift MT Messages', isCore: true },
