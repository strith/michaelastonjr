...
export const skills: Skill[] = [
  ...
  { category: 'Client', name: 'D3.js', isCore: true },
  ...
  { category: 'Client', name: 'Redux', isCore: true },
  ...
  { category: 'AI/ML & Data', name: 'Amazon SageMaker *', isCore: true },
